...
Sua tarefa é calcular o total de vendas e a média mensal de vendas que serão usados para gerar relatórios e gráficos no Power BI,
...
def obter_entrada_vendas():
    ...
    entrada = input("Digite o resultado anual separando cada mês por virgulas")
